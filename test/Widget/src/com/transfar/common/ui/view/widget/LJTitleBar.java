...
public class LJTitleBar extends RelativeLayout {
	...
	public LJTitleBar(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public LJTitleBar(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		setWillNotDraw(false);
		LayoutInflater.from(context).inflate(R.layout.lj_title_bar, this,
				true);
		initView(context);
	}
